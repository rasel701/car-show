  ...
  return (
    <>
      <motion.div
        ...
        className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl border border-gray-100/50 group flex flex-col transition-all duration-300 h-full"
      >
        ...
        <div className="p-6 flex-grow flex flex-col">
          ...
          <div className="mt-auto flex justify-between items-center gap-4">
            ...
            <button
              ...
              className="flex-grow bg-gradient-to-r from-green-600 to-green-800 text-white px-5 py-3.5 rounded-2xl font-bold text-sm hover:from-green-700 hover:to-green-900 transition-all shadow-md active:scale-95 cursor-pointer"
            >
              View Details
            </button>
          </div>
